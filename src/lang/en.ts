export const languageEnglish = {
    ...
    help: {
        ...
        romanizer:
            "Romanizer converts non-roman characters to roman characters to reduce tokens when using non-roman characters while requesting data. this can result diffrent output from the original model. it is not recommended to use this feature when using roman characters on chat.",
        inlayImages: "If enabled, images could be inlayed to the chat and AIs can see it if they support it.",
        metrica:
            "Metric Systemizer converts metrics to imperial units when request, and vice versa on output to show user metric system while using imperial for performace. it is not recommended to use this feature when using imperial units on chat.",
        ...
        openAIFixer: "OpenAI Fixer is a compatibility feature that fixes some of the problems of OpenAI.",
    ...
    chatBackgroundDefault: "Forest",
    chatBackgroundUpload: "Upload",
    chatBackgroundReplace: "Replace",
