...
<SelectInput bind:value className={`${className} control-field`.trim()}>
    {#if 'gpu' in navigator}
        ...
        <OptionInput value="bgeLargeEnGPU">BGE Large English (GPU)</OptionInput>
    ...
    <OptionInput value="bgeLargeEn">BGE Large English (CPU)</OptionInput>
