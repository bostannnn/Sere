...
{#if bulkEditState.isEnabled}
  <div class="hypa-bulk-shell panel-shell">
    <div class="hypa-bulk-row action-rail">
      ...
      <div class="hypa-bulk-left action-rail">
        <!-- Resummarize Button -->
        <button
          class="hypa-bulk-btn hypa-bulk-btn-primary"
          class:is-disabled={bulkEditState.selectedSummaries.size < 2}
