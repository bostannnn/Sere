...
export const defaultCBSRegisterArg: CBSRegisterArg = {
    ...
    getSelectedCharID: () => 0,
    callInternalFunction: (_args: string[]) => {return ''},
    isNodeServer: false,
    isMobile: false,
    appVer: '0.0.0',
    getModelInfo: () => ({
...
export function registerCBS(arg:CBSRegisterArg) {
    ...
    registerFunction({
        ...
        callback: (str, matcherArg, _args, _vars) => {
            ...
            let message: typeof chat.message[number] | null = null
            let previous_message: typeof chat.message[number] | null = null
            while(pointer >= 0){
                if(chat.message[pointer].role === 'user'){
    ...
    registerFunction({
        name: 'getvar',
        callback: (str, matcherArg, args, _vars) => {
    ...
    registerFunction({
        name: 'reverse',
        callback: (str, _matcherArg, _args, _vars) => {
