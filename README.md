...
- **Long-term Memory**: Advanced memory systems including HypaMemoryV2/V3 (with optional periodic summarization) and SupaMemory for context management to maintain long-term conversation context.
- And More!
...
- `docs/ONBOARDING.md` — **start here**: repo layout, rules map, key files, current state
- `CONVENTIONS.md` — repo-wide development rules (security, types, architecture, workflow)
