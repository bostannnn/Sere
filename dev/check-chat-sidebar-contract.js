...
ensureIncludes(chatScreenContent, chatScreenFile, "type RightPanelTab = \"chat\" | \"character\" | \"memory\" | \"evolution\";", failures);
...
ensureIncludes(chatScreenContent, chatScreenFile, "evolutionTabLabel=\"Evolution\"", failures);
...
ensureIncludes(hostContent, hostFile, "const rightPanelTabs: RightPanelTab[] = [\"chat\", \"character\", \"memory\", \"evolution\"];", failures);
...
ensureIncludes(hostContent, hostFile, "await selectTabAndFocus(\"evolution\");", failures);
...
ensureIncludes(hostContent, hostFile, "data-testid=\"chat-sidebar-tab-evolution\"", failures);
...
ensureIncludes(hostContent, hostFile, "id=\"chat-sidebar-tab-evolution\"", failures);
...
ensureIncludes(hostContent, hostFile, "aria-selected={rightSidebarTab === \"evolution\"}", failures);
...
ensureIncludes(hostContent, hostFile, "aria-controls={evolutionPanelId}", failures);
...
ensureIncludes(hostContent, hostFile, "tabindex={rightSidebarTab === \"evolution\" ? 0 : -1}", failures);
...
ensureIncludes(hostContent, hostFile, "onclick={() => selectTabAndFocus(\"evolution\")}", failures);
...
ensureIncludes(hostContent, hostFile, "onkeydown={(event) => handleRightPanelTabKeydown(event, \"evolution\")}", failures);
...
ensureIncludes(hostContent, hostFile, "class:ds-chat-right-panel-tab-active={rightSidebarTab === \"evolution\"}", failures);
...
ensureIncludes(hostContent, hostFile, "class:active={rightSidebarTab === \"evolution\"}", failures);
...
ensureIncludes(hostContent, hostFile, "class:is-active={rightSidebarTab === \"evolution\"}", failures);
...
ensureIncludes(hostContent, hostFile, "data-testid=\"chat-sidebar-pane-evolution\"", failures);
...
ensureIncludes(hostContent, hostFile, "aria-labelledby=\"chat-sidebar-tab-evolution\"", failures);
ensureIncludes(hostContent, hostFile, "onkeydown={(event) => handleRightPanelTabKeydown(event, \"chat\")}", failures);
