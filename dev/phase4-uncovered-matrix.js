/** @typedef {import("./check-phase4-surface-coverage.js").SurfaceMatrixEntry} SurfaceMatrixEntry */

/** @type {SurfaceMatrixEntry[]} */
export const PHASE4_UNCOVERED_MATRIX = [
  {
  ...
  },
  {
    ...
    classification: "migrate",
    owner: "ui-shell-contract",
    rationale: "Base alert modal centralizes overlay, action-row, and error-detail primitives while remaining mounted through the aggregate alert host.",
    requiredPatterns: [
      "class=\"alert-overlay\"",
      "class=\"alert-modal-base break-any\"",
  ...
  },
  {
    ...
    classification: "migrate",
    owner: "ui-shell-contract",
    rationale: "Branch overlay keeps dedicated close-button semantics and branch-node shell markers, but it is composed only through the aggregate alert host.",
    requiredPatterns: [
      "class=\"alert-branches-overlay\"",
  ...
  },
  {
    ...
    classification: "migrate",
    owner: "ui-shell-contract",
    rationale: "Legacy HypaV2 inspection modal uses explicit toolbar and close-button primitives and is routed through the aggregate alert host.",
    requiredPatterns: [
      "class=\"alert-hypav2-toolbar\"",
  ...
  },
  {
    ...
    classification: "migrate",
    owner: "ui-shell-contract",
    rationale: "Request-data modal exposes tabbed diagnostics and explicit close/copy actions while remaining mounted through the aggregate alert host.",
    requiredPatterns: [
      "class=\"alert-inline-toolbar\"",
      "class=\"alert-toolbar-close\"",
      "class=\"alert-requestdata-actions\"",
    ],
  },
  {
    ...
    classification: "migrate",
    owner: "ui-shell-contract",
    rationale: "Character select alert presents a dedicated tile grid surface via BarIcon composition and is only instantiated from the aggregate alert host.",
    requiredPatterns: [
      "class=\"alert-overlay\"",
      "class=\"alert-select-char-grid\"",
  ...
  },
  {
    ...
    classification: "migrate",
    owner: "ui-shell-contract",
    rationale: "Toast surface is an ephemeral shell primitive with deterministic close-on-animation behavior and is mounted exclusively through the aggregate alert host.",
    requiredPatterns: [
      "class=\"ds-toast-anime ds-toast-shell break-any\"",
      "onanimationend={() => {",
    ],
  },
  {
